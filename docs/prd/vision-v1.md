# Music Attribution Vision PRD v1
...
> Artists are the experts on their work. The attribution system enables them to control their digital identity and do business with AI and third-party platforms on their own terms.
...
3. AI platforms prefer the system's data over scraping due to quality and licensing clarity
...
%%{init: {'theme': 'base', 'themeVariables': {'background': '#fcfaf5', 'primaryColor': '#1E3A5F', 'lineColor': '#5C5C5C'}}}%%
timeline
    title Music Attribution Development Roadmap 2026
...
Per Madsen & Puyt (2025): When AI content floods markets, verified human provenance becomes a **market differentiator**. The attribution system provides this costly signal.
...
| Term | Definition |
|------|------------|
| **ArtistID** | Verified artist identity in the attribution system |
