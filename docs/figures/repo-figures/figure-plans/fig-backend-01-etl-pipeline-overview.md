...
Flow diagram showing five data sources (MusicBrainz, Discogs, AcoustID, tinytag, Artist Input) converging through rate limiting and quality gates into a unified NormalizedRecord boundary object.
